...
hero:
  name: Guia Mega do Realme 8
  tagline: Desbloqueie, rootceie e instale ROMs personalizadas no Realme 8 (RMX3085)
  actions:
    - theme: brand
      text: Começar
      link: /pt-BR/guides/backup
    - theme: alt
      text: Telegram
      link: https://t.me/Realme8AOSPGroup
...
features:
  - title: Desbloqueio
    ...
    details: Desbloqueie o bootloader via MTK Client. Funciona independentemente da versão da firmware.
    link: /pt-BR/guides/unlock
  - title: ROMs Personalizadas
    ...
    details: Flash em recoveries personalizadas (OrangeFox, TWRP, PBRP) e instale ROMs personalizadas.
    link: /pt-BR/guides/custom-rom
  - title: Root
    ...
    details: Root com Magisk ou KernelSU.
    link: /pt-BR/guides/rooting
  - title: Firmware Base
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="16.5" y1="9.4" x2="7.5" y2="4.21"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>
    details: Flash C.18 (RUI3) ou F.11 (RUI4) para compatibilidade com ROMs personalizadas.
    link: /pt-BR/guides/base-firmware
  - title: Referência
    ...
    details: Tabelas de download de recovery e kernel.
    link: /pt-BR/reference/recoveries
---
