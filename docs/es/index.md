...
hero:
  ...
  tagline: Desbloquea, haz root e instala ROMs personalizadas en el Realme 8 (RMX3085)
  actions:
    - theme: brand
      text: Comenzar
      link: /es/guides/backup
    - theme: alt
      text: Telegram
...
features:
  - title: Desbloqueo
    ...
    details: Desbloquea tu bootloader mediante MTK Client. Funciona sin importar la versión de firmware.
    link: /es/guides/unlock
  - title: ROMs personalizadas
    ...
    details: Instala recoveries personalizadas (OrangeFox, TWRP, PBRP) y ROMs personalizadas.
    link: /es/guides/custom-rom
  - title: Root
    ...
    details: Haz root con Magisk o KernelSU.
    link: /es/guides/rooting
  - title: Firmware base
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="16.5" y1="9.4" x2="7.5" y2="4.21"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>
    details: Instala C.18 (RUI3) o F.11 (RUI4) para compatibilidad con ROMs personalizadas.
    link: /es/guides/base-firmware
  - title: Referencia
    ...
    details: Tablas de referencia de recuperaciones y flash tool.
    link: /es/reference/recoveries
---
