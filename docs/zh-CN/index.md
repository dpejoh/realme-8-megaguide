...
hero:
  name: Realme 8 超级指南
  tagline: 解锁、root 并在 Realme 8 (RMX3085) 上安装自定义 ROM
  actions:
    - theme: brand
      text: 开始
      link: /zh-CN/guides/backup
    - theme: alt
      text: Telegram
...
features:
  - title: 解锁
    ...
    details: 通过 MTK Client 解锁引导加载程序。适用于任何固件版本。
    link: /zh-CN/guides/unlock
  - title: 自定义 ROM
    ...
    details: 刷写自定义恢复（OrangeFox、TWRP、PBRP）并安装自定义 ROM。
    link: /zh-CN/guides/custom-rom
  - title: Root
    ...
    details: 使用 Magisk 或 KernelSU 获取 root 权限。
    link: /zh-CN/guides/rooting
  - title: 基础固件
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="16.5" y1="9.4" x2="7.5" y2="4.21"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>
    details: 刷写 C.18 (RUI3) 或 F.11 (RUI4) 以获得自定义 ROM 兼容性。
    link: /zh-CN/guides/base-firmware
  - title: 参考
    ...
    details: 恢复和刷写工具参考表。
    link: /zh-CN/reference/recoveries
---
